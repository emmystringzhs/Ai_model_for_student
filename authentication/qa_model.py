...
data['Question'] = data['ArticleTitle'] + " " + data['Question'] + " " + data[
    'Answer']  # include article title and answer for more information
...
"""We calculate the ideal number of SVD variables to use on the data by adding up the cumulative variance till it's 
80%. This cap at 80% prevents overfitting of the model"""
